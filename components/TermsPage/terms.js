        ...
        <>
            <div className="container mt-3">
                ...
                <p>The following terminology applies to these Terms and Conditions,
                    ...
                    "You," and "Your" refer to you, the person logging on this website and compliant
                    to the Company's terms and conditions. "The Company," "Ourselves," "We,
                    " "Our," and "Us" refer to our Company. "Party," "Parties," or "Us" refers
                    to both the Client and ourselves. All terms refer to the offer, acceptance,
                    and consideration of payment necessary to undertake the process of our assistance
                    to the Client in the most appropriate manner for the express purpose of meeting the
                    Client's needs in respect to the provision of the Company's stated services, following
                    and subject to the prevailing law of Naatumaadu. Any use of the above terminology or
                ...
                <h4>COOKIES</h4>
                <p>We employ the use of cookies. By accessing Naatumaadu,
                    you agree to use cookies in agreement with NaatuMaadu Privacy Policy.
                ...
                <h4>LICENSE</h4>
                <p>Unless otherwise stated, Naatumaadu and/or its licensors own the intellectual
                    property rights for all material on Naatumaadu. All intellectual property rights
                    are reserved. You may access this from Naatumaadu for your own personal use, subject
                    to restrictions set in these terms and conditions.
                </p>

                <li>You must not republish material from Naatumaadu.</li>
                <li>You must not sell, rent, or sub-license material from Naatumaadu.</li>
                <li>You must not reproduce, duplicate, or copy material from Naatumaadu.</li>
                <li>You must not redistribute content from Naatumaadu.</li>


                <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                    information in certain areas of the website. NaatuMaadu does not filter, edit, publish
                    , or review Comments prior to their presence on the website. Comments do not reflect
                    the views and opinions of Sri Dhanlakshmi Collection Silk, its agents, and/or
                    affiliates. Comments reflect the views and opinions of the person who posts
                    their views and opinions. To the extent permitted by applicable laws, Sri Dhanlakshmi
                    Collection Silk shall not be liable for the Comments or for any liability,
                    damages, or expenses caused and/or suffered as a result of any use of and/or
                    posting of and/or appearance of the Comments on this website.
                </p>

                <p>Naatumaadu reserves the right to monitor all Comments and to remove any Comments
                    that can be considered inappropriate, offensive, or cause a breach of these Terms
                    and Conditions.
                </p>

                <h4>COMMENT POSTING GUIDELINES</h4>
                <li>You warrant and represent that you are entitled to post the Comments on our
                ...
                <li>The Comments do not contain any defamatory, libelous, offensive, indecent,
                    or otherwise unlawful material which is an invasion of privacy.
                </li>
                <li>The Comments will not be used to solicit or promote business or custom
                    or present commercial activities or unlawful activity.
                </li>

                <p>You hereby grant NaatuMaadu a non-exclusive license to use, reproduce, edit,
                ...
                <p>These organizations may link to our home page, to publications,
                    or to other Website information so long as the link:</p>

                <ol>
                    <li>is not in any way deceptive;</li>
                    <li>does not falsely imply sponsorship, endorsement,
                        or approval of the linking party and its products and/or services; </li>
                ...
                <p>We shall not be held responsible for any content that appears on your Website. You agree
                    to protect and defend us against all claims that are rising on your Website. No
                    link(s) should appear on any Website that may be interpreted as libelous, obscene,
                    or criminal, or which infringes, otherwise violates, or advocates the infringement
                ...
                <p>If you find any link on our Website that is offensive for any reason, you are free
                    to contact and inform us at any moment. We will consider requests to remove links
                    but are not obligated to do so or to respond to you directly.
                </p>
                <h4>DISCLAIMER</h4>
